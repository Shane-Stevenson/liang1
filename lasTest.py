...
squareLength = 10   #This controls the length of each box i.e. The samples will be squareLength x squareLength in area
...
point's x-position and the minimum x value by squareLength. This process is repeated for the y value and then the point is appended
to boxes
"""
for i in point_data:
    xIndex = math.floor((i[0] - XMIN)/squareLength)
    yIndex = math.floor((i[1] - YMIN)/squareLength)
